...
- `lib/i18n/zh-TW.json` maps English source copy to Traditional Chinese and
  `lib/i18n/pt-BR.json` to Brazilian Portuguese. Every catalog carries the same
  keys. Use complete sentences with named placeholders when word order can vary.
